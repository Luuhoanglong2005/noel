...
$(document).ready(function () {
  var $card = $(".card"),
    ...
    let textTitle = "Gửi Bảo Hân";
    let charArrTitle = textTitle.split('');
let text = "Mùa Giáng Sinh này, chúc chị luôn được bao quanh bởi sự ấm áp, tình yêu thương và niềm vui bất tận. Chúc chị và gia đình một mùa Giáng Sinh tràn đầy hạnh phúc!"
